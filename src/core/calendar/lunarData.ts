 ...
 *   - Bits 0-11: each bit = 1 means 30 days, 0 means 29 days (month 1 to 12)
 *   - Bits 16-19: leap month number (0 = no leap month)
...
export function lunarYearDays(year: number): number {
  let sum = 348; // 12 months * 29 days = 348 base
