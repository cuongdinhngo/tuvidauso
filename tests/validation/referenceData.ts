...
export const REFERENCE_CASES: ReferenceCase[] = [
  ...
  },
  {
    ...
    expected: {
      ...
      mainStars: { 'Tử Vi': 'Mão', 'Thiên Cơ': 'Dần', 'Thái Dương': 'Tý', 'Vũ Khúc': 'Hợi', 'Thiên Đồng': 'Tuất', 'Liêm Trinh': 'Mùi', 'Thiên Phủ': 'Sửu', 'Thái Âm': 'Dần', 'Tham Lang': 'Mão', 'Cự Môn': 'Thìn', 'Thiên Tướng': 'Tị', 'Thiên Lương': 'Ngọ', 'Thất Sát': 'Mùi', 'Phá Quân': 'Hợi' },
      mainStarCount: 14, palaceCount: 12,
    },
    verified: false,
  },
