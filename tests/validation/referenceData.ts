...
export const REFERENCE_CASES: ReferenceCase[] = [
  {
    ...
    expected: {
      ...
      mainStars: { 'Tử Vi': 'Sửu', 'Thiên Cơ': 'Tý', 'Thái Dương': 'Tuất', 'Vũ Khúc': 'Dậu', 'Thiên Đồng': 'Thân', 'Liêm Trinh': 'Tị', 'Thiên Phủ': 'Mão', 'Thái Âm': 'Thìn', 'Tham Lang': 'Tị', 'Cự Môn': 'Ngọ', 'Thiên Tướng': 'Mùi', 'Thiên Lương': 'Thân', 'Thất Sát': 'Dậu', 'Phá Quân': 'Sửu' },
  ...
  },
  {
    ...
    expected: {
      ...
      mainStars: { 'Tử Vi': 'Dần', 'Thiên Cơ': 'Sửu', 'Thái Dương': 'Hợi', 'Vũ Khúc': 'Tuất', 'Thiên Đồng': 'Dậu', 'Liêm Trinh': 'Ngọ', 'Thiên Phủ': 'Dần', 'Thái Âm': 'Mão', 'Tham Lang': 'Thìn', 'Cự Môn': 'Tị', 'Thiên Tướng': 'Ngọ', 'Thiên Lương': 'Mùi', 'Thất Sát': 'Thân', 'Phá Quân': 'Tý' },
      mainStarCount: 14, palaceCount: 12,
    },
    verified: false,
  },
  {
    ...
    expected: {
      ...
      menh: 'Thìn', than: 'Thân', cucName: 'Kim Tứ Cục', cucValue: 4,
      tuHoa: { loc: 'Thiên Cơ', quyen: 'Thiên Lương', khoa: 'Tử Vi', ky: 'Thái Âm' },
      mainStars: { 'Tử Vi': 'Ngọ', 'Thiên Cơ': 'Tị', 'Thái Dương': 'Mão', 'Vũ Khúc': 'Dần', 'Thiên Đồng': 'Sửu', 'Liêm Trinh': 'Tuất', 'Thiên Phủ': 'Tuất', 'Thái Âm': 'Hợi', 'Tham Lang': 'Tý', 'Cự Môn': 'Sửu', 'Thiên Tướng': 'Dần', 'Thiên Lương': 'Mão', 'Thất Sát': 'Thìn', 'Phá Quân': 'Thân' },
      mainStarCount: 14, palaceCount: 12,
    },
    verified: false,
  },
  {
    ...
    expected: {
      ...
      menh: 'Mùi', than: 'Dậu', cucName: 'Mộc Tam Cục', cucValue: 3,
      tuHoa: { loc: 'Thái Dương', quyen: 'Vũ Khúc', khoa: 'Thái Âm', ky: 'Thiên Đồng' },
      mainStars: { 'Tử Vi': 'Tuất', 'Thiên Cơ': 'Dậu', 'Thái Dương': 'Mùi', 'Vũ Khúc': 'Ngọ', 'Thiên Đồng': 'Tị', 'Liêm Trinh': 'Dần', 'Thiên Phủ': 'Ngọ', 'Thái Âm': 'Mùi', 'Tham Lang': 'Thân', 'Cự Môn': 'Dậu', 'Thiên Tướng': 'Tuất', 'Thiên Lương': 'Hợi', 'Thất Sát': 'Tý', 'Phá Quân': 'Thìn' },
      mainStarCount: 14, palaceCount: 12,
    },
    verified: false,
  },
  {
    ...
    expected: {
      ...
      menh: 'Dần', than: 'Dần', cucName: 'Thổ Ngũ Cục', cucValue: 5,
      tuHoa: { loc: 'Thái Dương', quyen: 'Vũ Khúc', khoa: 'Thái Âm', ky: 'Thiên Đồng' },
      mainStars: { 'Tử Vi': 'Thìn', 'Thiên Cơ': 'Mão', 'Thái Dương': 'Sửu', 'Vũ Khúc': 'Tý', 'Thiên Đồng': 'Hợi', 'Liêm Trinh': 'Thân', 'Thiên Phủ': 'Tý', 'Thái Âm': 'Sửu', 'Tham Lang': 'Dần', 'Cự Môn': 'Mão', 'Thiên Tướng': 'Thìn', 'Thiên Lương': 'Tị', 'Thất Sát': 'Ngọ', 'Phá Quân': 'Tuất' },
      mainStarCount: 14, palaceCount: 12,
    },
    verified: false,
  },
  {
    ...
    expected: {
      ...
      menh: 'Hợi', than: 'Mùi', cucName: 'Thổ Ngũ Cục', cucValue: 5,
      tuHoa: { loc: 'Thiên Cơ', quyen: 'Thiên Lương', khoa: 'Tử Vi', ky: 'Thái Âm' },
      mainStars: { 'Tử Vi': 'Ngọ', 'Thiên Cơ': 'Tị', 'Thái Dương': 'Mão', 'Vũ Khúc': 'Dần', 'Thiên Đồng': 'Sửu', 'Liêm Trinh': 'Tuất', 'Thiên Phủ': 'Tuất', 'Thái Âm': 'Hợi', 'Tham Lang': 'Tý', 'Cự Môn': 'Sửu', 'Thiên Tướng': 'Dần', 'Thiên Lương': 'Mão', 'Thất Sát': 'Thìn', 'Phá Quân': 'Thân' },
      mainStarCount: 14, palaceCount: 12,
    },
  ...
  },
  {
    ...
    expected: {
      ...
      menh: 'Tý', than: 'Thìn', cucName: 'Mộc Tam Cục', cucValue: 3,
      tuHoa: { loc: 'Thiên Lương', quyen: 'Tử Vi', khoa: 'Tả Phụ', ky: 'Vũ Khúc' },
      mainStars: { 'Tử Vi': 'Thân', 'Thiên Cơ': 'Mùi', 'Thái Dương': 'Tị', 'Vũ Khúc': 'Thìn', 'Thiên Đồng': 'Mão', 'Liêm Trinh': 'Tý', 'Thiên Phủ': 'Thân', 'Thái Âm': 'Dậu', 'Tham Lang': 'Tuất', 'Cự Môn': 'Hợi', 'Thiên Tướng': 'Tý', 'Thiên Lương': 'Sửu', 'Thất Sát': 'Dần', 'Phá Quân': 'Ngọ' },
      mainStarCount: 14, palaceCount: 12,
    },
    verified: false,
  },
  {
    ...
    expected: {
      ...
      menh: 'Sửu', than: 'Dậu', cucName: 'Kim Tứ Cục', cucValue: 4,
      tuHoa: { loc: 'Tham Lang', quyen: 'Thái Âm', khoa: 'Hữu Bật', ky: 'Thiên Cơ' },
      mainStars: { 'Tử Vi': 'Tị', 'Thiên Cơ': 'Thìn', 'Thái Dương': 'Dần', 'Vũ Khúc': 'Sửu', 'Thiên Đồng': 'Tý', 'Liêm Trinh': 'Dậu', 'Thiên Phủ': 'Hợi', 'Thái Âm': 'Tý', 'Tham Lang': 'Sửu', 'Cự Môn': 'Dần', 'Thiên Tướng': 'Mão', 'Thiên Lương': 'Thìn', 'Thất Sát': 'Tị', 'Phá Quân': 'Dậu' },
      mainStarCount: 14, palaceCount: 12,
    },
    verified: false,
  },
  {
    ...
    expected: {
      ...
      menh: 'Mão', than: 'Tị', cucName: 'Thủy Nhị Cục', cucValue: 2,
  ...
  },
  {
    ...
    expected: {
      ...
      menh: 'Dần', than: 'Tý', cucName: 'Thổ Ngũ Cục', cucValue: 5,
      tuHoa: { loc: 'Thiên Cơ', quyen: 'Thiên Lương', khoa: 'Tử Vi', ky: 'Thái Âm' },
      mainStars: { 'Tử Vi': 'Thân', 'Thiên Cơ': 'Mùi', 'Thái Dương': 'Tị', 'Vũ Khúc': 'Thìn', 'Thiên Đồng': 'Mão', 'Liêm Trinh': 'Tý', 'Thiên Phủ': 'Thân', 'Thái Âm': 'Dậu', 'Tham Lang': 'Tuất', 'Cự Môn': 'Hợi', 'Thiên Tướng': 'Tý', 'Thiên Lương': 'Sửu', 'Thất Sát': 'Dần', 'Phá Quân': 'Ngọ' },
      mainStarCount: 14, palaceCount: 12,
    },
  ...
  },
  {
    ...
    expected: {
      ...
      mainStars: { 'Tử Vi': 'Mùi', 'Thiên Cơ': 'Ngọ', 'Thái Dương': 'Thìn', 'Vũ Khúc': 'Mão', 'Thiên Đồng': 'Dần', 'Liêm Trinh': 'Hợi', 'Thiên Phủ': 'Dậu', 'Thái Âm': 'Tuất', 'Tham Lang': 'Hợi', 'Cự Môn': 'Tý', 'Thiên Tướng': 'Sửu', 'Thiên Lương': 'Dần', 'Thất Sát': 'Mão', 'Phá Quân': 'Mùi' },
      mainStarCount: 14, palaceCount: 12,
    },
    verified: false,
  },
  {
    ...
    expected: {
      ...
      menh: 'Mão', than: 'Dậu', cucName: 'Thổ Ngũ Cục', cucValue: 5,
      tuHoa: { loc: 'Thiên Cơ', quyen: 'Thiên Lương', khoa: 'Tử Vi', ky: 'Thái Âm' },
      mainStars: { 'Tử Vi': 'Thìn', 'Thiên Cơ': 'Mão', 'Thái Dương': 'Sửu', 'Vũ Khúc': 'Tý', 'Thiên Đồng': 'Hợi', 'Liêm Trinh': 'Thân', 'Thiên Phủ': 'Tý', 'Thái Âm': 'Sửu', 'Tham Lang': 'Dần', 'Cự Môn': 'Mão', 'Thiên Tướng': 'Thìn', 'Thiên Lương': 'Tị', 'Thất Sát': 'Ngọ', 'Phá Quân': 'Tuất' },
      mainStarCount: 14, palaceCount: 12,
    },
  ...
  },
  {
    ...
    expected: {
      ...
      menh: 'Mão', than: 'Sửu', cucName: 'Thủy Nhị Cục', cucValue: 2,
      tuHoa: { loc: 'Tham Lang', quyen: 'Thái Âm', khoa: 'Hữu Bật', ky: 'Thiên Cơ' },
      mainStars: { 'Tử Vi': 'Sửu', 'Thiên Cơ': 'Tý', 'Thái Dương': 'Tuất', 'Vũ Khúc': 'Dậu', 'Thiên Đồng': 'Thân', 'Liêm Trinh': 'Tị', 'Thiên Phủ': 'Mão', 'Thái Âm': 'Thìn', 'Tham Lang': 'Tị', 'Cự Môn': 'Ngọ', 'Thiên Tướng': 'Mùi', 'Thiên Lương': 'Thân', 'Thất Sát': 'Dậu', 'Phá Quân': 'Sửu' },
      mainStarCount: 14, palaceCount: 12,
    },
  ...
  },
  {
    ...
    expected: {
      ...
      menh: 'Dần', than: 'Ngọ', cucName: 'Thổ Ngũ Cục', cucValue: 5,
      tuHoa: { loc: 'Thiên Cơ', quyen: 'Thiên Lương', khoa: 'Tử Vi', ky: 'Thái Âm' },
      mainStars: { 'Tử Vi': 'Mùi', 'Thiên Cơ': 'Ngọ', 'Thái Dương': 'Thìn', 'Vũ Khúc': 'Mão', 'Thiên Đồng': 'Dần', 'Liêm Trinh': 'Hợi', 'Thiên Phủ': 'Dậu', 'Thái Âm': 'Tuất', 'Tham Lang': 'Hợi', 'Cự Môn': 'Tý', 'Thiên Tướng': 'Sửu', 'Thiên Lương': 'Dần', 'Thất Sát': 'Mão', 'Phá Quân': 'Mùi' },
      mainStarCount: 14, palaceCount: 12,
    },
  ...
  },
  {
    ...
    expected: {
      ...
      menh: 'Ngọ', than: 'Thân', cucName: 'Thổ Ngũ Cục', cucValue: 5,
  ...
  },
  {
    ...
    expected: {
      ...
      yearCan: 'Canh', yearChi: 'Tý', napAm: 'Bích Thượng Thổ',
      menh: 'Dậu', than: 'Dậu', cucName: 'Thủy Nhị Cục', cucValue: 2,
      tuHoa: { loc: 'Thái Dương', quyen: 'Vũ Khúc', khoa: 'Thái Âm', ky: 'Thiên Đồng' },
      mainStars: { 'Tử Vi': 'Dậu', 'Thiên Cơ': 'Thân', 'Thái Dương': 'Ngọ', 'Vũ Khúc': 'Tị', 'Thiên Đồng': 'Thìn', 'Liêm Trinh': 'Sửu', 'Thiên Phủ': 'Mùi', 'Thái Âm': 'Thân', 'Tham Lang': 'Dậu', 'Cự Môn': 'Tuất', 'Thiên Tướng': 'Hợi', 'Thiên Lương': 'Tý', 'Thất Sát': 'Sửu', 'Phá Quân': 'Tị' },
      mainStarCount: 14, palaceCount: 12,
    },
    verified: false,
  },
  {
    ...
    expected: {
      ...
      menh: 'Dậu', than: 'Sửu', cucName: 'Thổ Ngũ Cục', cucValue: 5,
      tuHoa: { loc: 'Thiên Lương', quyen: 'Tử Vi', khoa: 'Tả Phụ', ky: 'Vũ Khúc' },
      mainStars: { 'Tử Vi': 'Thìn', 'Thiên Cơ': 'Mão', 'Thái Dương': 'Sửu', 'Vũ Khúc': 'Tý', 'Thiên Đồng': 'Hợi', 'Liêm Trinh': 'Thân', 'Thiên Phủ': 'Tý', 'Thái Âm': 'Sửu', 'Tham Lang': 'Dần', 'Cự Môn': 'Mão', 'Thiên Tướng': 'Thìn', 'Thiên Lương': 'Tị', 'Thất Sát': 'Ngọ', 'Phá Quân': 'Tuất' },
      mainStarCount: 14, palaceCount: 12,
    },
  ...
  },
  {
    ...
    expected: {
      ...
      menh: 'Tuất', than: 'Tuất', cucName: 'Thủy Nhị Cục', cucValue: 2,
      tuHoa: { loc: 'Phá Quân', quyen: 'Cự Môn', khoa: 'Thái Âm', ky: 'Tham Lang' },
      mainStars: { 'Tử Vi': 'Tý', 'Thiên Cơ': 'Hợi', 'Thái Dương': 'Dậu', 'Vũ Khúc': 'Thân', 'Thiên Đồng': 'Mùi', 'Liêm Trinh': 'Thìn', 'Thiên Phủ': 'Thìn', 'Thái Âm': 'Tị', 'Tham Lang': 'Ngọ', 'Cự Môn': 'Mùi', 'Thiên Tướng': 'Thân', 'Thiên Lương': 'Dậu', 'Thất Sát': 'Tuất', 'Phá Quân': 'Dần' },
      mainStarCount: 14, palaceCount: 12,
    },
    verified: false,
  },
